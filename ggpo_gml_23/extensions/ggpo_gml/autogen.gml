...
var _buf = ggpo_gml_prepare_buffer(16);
var _val_0 = argument0;
var _wb_0;
if (buffer_exists(_val_0)) {
	if (ggpo_gml_is_js) {
		var _len_0 = buffer_get_size(_val_0);
		_wb_0 = ggpo_gml_wasm_alloc(_len_0, buffer_get_address(_val_0));
		buffer_write(_buf, buffer_u64, _wb_0);
		buffer_write(_buf, buffer_s32, _len_0);
...
return ggpo_start_session_raw(buffer_get_address(_buf), 6);
...
return ggpo_start_spectating_raw(buffer_get_address(_buf), 9, argument2);
...
return ggpo_start_synctest_raw(buffer_get_address(_buf), 8);

#define ggpo_close_session
/// ggpo_close_session()->int
var _buf = ggpo_gml_prepare_buffer(1);
return ggpo_close_session_raw(buffer_get_address(_buf), 1);

#define ggpo_add_local_player
/// ggpo_add_local_player(player_num:int)->int?
var _buf = ggpo_gml_prepare_buffer(5);
buffer_write(_buf, buffer_s32, argument0);
if (ggpo_add_local_player_raw(buffer_get_address(_buf), 5)) {
...
if (ggpo_add_remote_player_raw(buffer_get_address(_buf), 7, argument1)) {
	buffer_seek(_buf, buffer_seek_start, 0);
	var _val_0;
	if (buffer_read(_buf, buffer_bool)) {
		_val_0 = buffer_read(_buf, buffer_s32);
...
var _buf = ggpo_gml_prepare_buffer(4);
buffer_write(_buf, buffer_s32, argument0);
return ggpo_disconnect_player_raw(buffer_get_address(_buf), 4);
...
buffer_write(_buf, buffer_s32, argument0);
buffer_write(_buf, buffer_s32, argument1);
return ggpo_set_frame_delay_raw(buffer_get_address(_buf), 8);

#define ggpo_add_local_input
/// ggpo_add_local_input(player_handle:int, buf:buffer, ?size:int?)->int
var _buf = ggpo_gml_prepare_buffer(26);
...
var _result = ggpo_add_local_input_raw(buffer_get_address(_buf), 26);
if (ggpo_gml_is_js) ggpo_gml_wasm_free(_wb_0);
return _result;

#define ggpo_synchronize_input
/// ggpo_synchronize_input(out_buffer:buffer)->int
var _buf = ggpo_gml_prepare_buffer(16);
var _val_0 = argument0;
var _wb_0;
if (buffer_exists(_val_0)) {
	if (ggpo_gml_is_js) {
		var _len_0 = buffer_get_size(_val_0);
		_wb_0 = ggpo_gml_wasm_alloc(_len_0);
		buffer_write(_buf, buffer_u64, _wb_0);
		buffer_write(_buf, buffer_s32, _len_0);
		buffer_write(_buf, buffer_s32, buffer_tell(_val_0));
	} else {
...
var _result = ggpo_synchronize_input_raw(buffer_get_address(_buf), 16);
if (ggpo_gml_is_js) ggpo_gml_wasm_free(_wb_0, buffer_get_address(_val_0), buffer_get_size(_val_0));
return _result;

#define ggpo_preinit_2
/// ggpo_preinit_2(fixed_buffer:buffer)->int
var _buf = ggpo_gml_prepare_buffer(60);
...
var _result = ggpo_preinit_2_raw(buffer_get_address(_buf), 60);
if (ggpo_gml_is_js) ggpo_gml_wasm_free(_wb_0);
return _result;
