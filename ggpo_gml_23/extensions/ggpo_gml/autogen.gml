...
return ggpo_start_spectating_raw(buffer_get_address(_buf), 16, argument2);
...
var _buf = ggpo_gml_prepare_buffer(14);
buffer_write(_buf, buffer_s32, argument0);
buffer_write(_buf, buffer_u16, argument2);
if (ggpo_add_remote_player_raw(buffer_get_address(_buf), 14, argument1)) {
	buffer_seek(_buf, buffer_seek_start, 0);
	var _val_0;
	if (buffer_read(_buf, buffer_bool)) {
		_val_0 = buffer_read(_buf, buffer_s32);
...
return ggpo_add_local_input_raw(buffer_get_address(_buf), 26);
...
return ggpo_synchronize_input_raw(buffer_get_address(_buf), 16);
...
return ggpo_preinit_2_raw(buffer_get_address(_buf), 60);
